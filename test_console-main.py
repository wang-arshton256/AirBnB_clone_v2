...
"""
Backs up models/__init__.py file
"""
...
"""
Overwrites models/__init__.py file with switch_to_file_storage.py
"""
if os.path.exists("switch_to_file_storage.py"):
    shutil.copy("switch_to_file_storage.py", "models/__init__.py")

"""
Updates console to remove "__main__"
"""
